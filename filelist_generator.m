...
if Firstimagename~~[];
    ...
    Filename_first = Firstimagename(1:min(Numberpos));%I changed this line to min(Numberpos)
    Firstfilenumber=Firstimagename(min(Numberpos)+1:max(Numberpos));
    Lastname_first = Firstimagename(max(Numberpos)+1:Firstimagenamesize(1,2)); %I changed this line to max(Numberpos)+1
